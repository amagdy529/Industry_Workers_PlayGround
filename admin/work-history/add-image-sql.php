...
// [wh_id] => test [email] => a@a.com [password] => 123 [industry] => volvo [user_type] => 1
if (isset($_POST['wh_id'])) {
    $result = mysqli_query($global_mysqli, "INSERT INTO users (u_name,u_email,u_password,industry_no,user_type,u_img) VALUES ( '".$_POST["wh_id"]."', '".$_POST["email"]."', md5('".$_POST["password"]."'),
